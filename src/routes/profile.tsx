...
function ProfilePage() {
  ...
  async function changePassword(e: React.FormEvent) {
    ...
    if (!currentPw) {
      setFieldErrors({ current_password: "Enter your current password" });
      return;
    }
    if (!newPw) {
    ...
    if (!STRONG_PW_RE.test(newPw)) {
      setFieldErrors({
        new_password: "Must contain uppercase, lowercase, number & special character (8+ chars)",
      });
      return;
    }
    if (newPw !== confirmPw) {
        ...
        {loadingProfile ? (
          ...
          <>
              ...
              <form onSubmit={saveInfo} className="space-y-4 p-8">
                ...
                {infoSuccess && (
                  <div
                    ...
                    style={{
                      background: "oklch(0.42 0.18 150 / 8%)",
                      border: "1px solid oklch(0.42 0.18 150 / 25%)",
                      color: SUCCESS_COLOR,
                    }}
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  >
                    <span className="text-sm" style={{ color: "oklch(0.65 0.04 50)" }}>
                      {email}
                    </span>
                    <span className="ml-auto text-xs" style={{ color: "oklch(0.70 0.04 50)" }}>
                      Cannot change
                    </span>
                  </div>
                </div>
            ...
            >
              <div
                className="h-1.5 w-full"
                style={{ background: `linear-gradient(90deg, ${GOLD}, ${BURGUNDY})` }}
              />
              <form onSubmit={changePassword} className="space-y-4 p-8">
                ...
                <PasswordField
                  ...
                  id="current-pw"
                  onClearError={() => setFieldErrors((p) => ({ ...p, current_password: "" }))}
                />
                <PasswordField
                  label="New Password"
                  value={newPw}
                  ...
                  id="new-pw"
                  onClearError={() => setFieldErrors((p) => ({ ...p, new_password: "" }))}
                  hint="8+ chars, uppercase, lowercase, number & special character"
                />
                <PasswordField
                  ...
                  id="confirm-pw"
                  onClearError={() => setFieldErrors((p) => ({ ...p, confirm_password: "" }))}
                />
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl py-3 text-sm font-semibold shadow-lg transition-all duration-200 active:scale-[0.98] disabled:opacity-70"
                  style={{
                    background: `linear-gradient(135deg, ${GOLD}, oklch(0.72 0.14 65))`,
                    color: "white",
                  }}
                >
                  {savingPw ? (
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div
        ...
        style={{
          background: "oklch(0.998 0.004 85)",
          border: `1px solid ${hasError ? "oklch(0.577 0.245 27.325)" : focused ? GOLD : "oklch(0.88 0.030 82)"}`,
          boxShadow: focused
